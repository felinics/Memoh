...
export const getAgentCredentialsQueryKey = (options?: Options<GetAgentCredentialsData>) => createQueryKey('getAgentCredentials', options);

/**
 * List owned Agent credentials
 */
export const getAgentCredentialsQuery = defineQueryOptions<Options<GetAgentCredentialsData>, GetAgentCredentialsResponse, GetAgentCredentialsError>((options?: Options<GetAgentCredentialsData>) => ({
    key: getAgentCredentialsQueryKey(options),
    query: async (context) => {
...
/**
 * Create an encrypted Agent credential
 */
export const postAgentCredentialsMutation = (options?: Partial<Options<PostAgentCredentialsData>>): UseMutationOptions<PostAgentCredentialsResponse, Options<PostAgentCredentialsData>, PostAgentCredentialsError> => ({
    mutation: async (vars) => {
        const { data } = await postAgentCredentials({
            ...options,
            ...vars,
            throwOnError: true
        });
 ...
 */
export const deleteAgentCredentialsByCredentialIdMutation = (options?: Partial<Options<DeleteAgentCredentialsByCredentialIdData>>): UseMutationOptions<DeleteAgentCredentialsByCredentialIdResponse, Options<DeleteAgentCredentialsByCredentialIdData>, DeleteAgentCredentialsByCredentialIdError> => ({
    mutation: async (vars) => {
        const { data } = await deleteAgentCredentialsByCredentialId({
            ...options,
            ...vars,
            throwOnError: true
        });
...
/**
 * Rename an Agent credential
 */
export const patchAgentCredentialsByCredentialIdMutation = (options?: Partial<Options<PatchAgentCredentialsByCredentialIdData>>): UseMutationOptions<PatchAgentCredentialsByCredentialIdResponse, Options<PatchAgentCredentialsByCredentialIdData>, PatchAgentCredentialsByCredentialIdError> => ({
    mutation: async (vars) => {
        const { data } = await patchAgentCredentialsByCredentialId({
            ...options,
            ...vars,
            throwOnError: true
        });
...
export const getBotsByBotIdAgentsByAgentIdCredentialsQueryKey = (options: Options<GetBotsByBotIdAgentsByAgentIdCredentialsData>) => createQueryKey('getBotsByBotIdAgentsByAgentIdCredentials', options);

/**
 * List credentials bound to a Bot Agent
 */
export const getBotsByBotIdAgentsByAgentIdCredentialsQuery = defineQueryOptions<Options<GetBotsByBotIdAgentsByAgentIdCredentialsData>, GetBotsByBotIdAgentsByAgentIdCredentialsResponse, GetBotsByBotIdAgentsByAgentIdCredentialsError>((options: Options<GetBotsByBotIdAgentsByAgentIdCredentialsData>) => ({
    key: getBotsByBotIdAgentsByAgentIdCredentialsQueryKey(options),
    query: async (context) => {
...
/**
 * Bind a credential to a Bot Agent
 */
export const postBotsByBotIdAgentsByAgentIdCredentialsMutation = (options?: Partial<Options<PostBotsByBotIdAgentsByAgentIdCredentialsData>>): UseMutationOptions<PostBotsByBotIdAgentsByAgentIdCredentialsResponse, Options<PostBotsByBotIdAgentsByAgentIdCredentialsData>, PostBotsByBotIdAgentsByAgentIdCredentialsError> => ({
    mutation: async (vars) => {
        const { data } = await postBotsByBotIdAgentsByAgentIdCredentials({
            ...options,
            ...vars,
            throwOnError: true
        });
...
/**
 * Set the default credential for a Bot Agent
 */
export const putBotsByBotIdAgentsByAgentIdCredentialsDefaultMutation = (options?: Partial<Options<PutBotsByBotIdAgentsByAgentIdCredentialsDefaultData>>): UseMutationOptions<unknown, Options<PutBotsByBotIdAgentsByAgentIdCredentialsDefaultData>, PutBotsByBotIdAgentsByAgentIdCredentialsDefaultError> => ({
    mutation: async (vars) => {
        const { data } = await putBotsByBotIdAgentsByAgentIdCredentialsDefault({
            ...options,
            ...vars,
            throwOnError: true
        });
...
/**
 * Unbind a credential from a Bot Agent
 */
export const deleteBotsByBotIdAgentsByAgentIdCredentialsByCredentialIdMutation = (options?: Partial<Options<DeleteBotsByBotIdAgentsByAgentIdCredentialsByCredentialIdData>>): UseMutationOptions<unknown, Options<DeleteBotsByBotIdAgentsByAgentIdCredentialsByCredentialIdData>, DeleteBotsByBotIdAgentsByAgentIdCredentialsByCredentialIdError> => ({
    mutation: async (vars) => {
        const { data } = await deleteBotsByBotIdAgentsByAgentIdCredentialsByCredentialId({
            ...options,
            ...vars,
            throwOnError: true
        });
