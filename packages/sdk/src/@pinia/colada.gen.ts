...
export const getBotsByBotIdTelegramStickersQueryKey = (options: Options<GetBotsByBotIdTelegramStickersData>) => createQueryKey('getBotsByBotIdTelegramStickers', options);

/**
 * List Telegram stickers
 *
 * List the configured Telegram Sticker Set with visual descriptions and recognition status
 */
export const getBotsByBotIdTelegramStickersQuery = defineQueryOptions<Options<GetBotsByBotIdTelegramStickersData>, GetBotsByBotIdTelegramStickersResponse, GetBotsByBotIdTelegramStickersError>((options: Options<GetBotsByBotIdTelegramStickersData>) => ({
    key: getBotsByBotIdTelegramStickersQueryKey(options),
    query: async (context) => {
...
/**
 * Refresh Telegram Sticker Set metadata
 *
 * Explicitly replace the permanent Sticker Set metadata cache from Telegram
 */
export const postBotsByBotIdTelegramStickersRefreshMutation = (options?: Partial<Options<PostBotsByBotIdTelegramStickersRefreshData>>): UseMutationOptions<PostBotsByBotIdTelegramStickersRefreshResponse, Options<PostBotsByBotIdTelegramStickersRefreshData>, PostBotsByBotIdTelegramStickersRefreshError> => ({
    mutation: async (vars) => {
        const { data } = await postBotsByBotIdTelegramStickersRefresh({
            ...options,
            ...vars,
            throwOnError: true
        });
...
/**
 * Update Telegram Sticker Sets
 *
 * Replace the configured Sticker Set list. Sets are merged into one stable model-visible catalog.
 */
export const putBotsByBotIdTelegramStickersSetsMutation = (options?: Partial<Options<PutBotsByBotIdTelegramStickersSetsData>>): UseMutationOptions<PutBotsByBotIdTelegramStickersSetsResponse, Options<PutBotsByBotIdTelegramStickersSetsData>, PutBotsByBotIdTelegramStickersSetsError> => ({
    mutation: async (vars) => {
        const { data } = await putBotsByBotIdTelegramStickersSets({
            ...options,
            ...vars,
            throwOnError: true
        });
...
export const getBotsByBotIdTelegramStickersByStickerIdPreviewQueryKey = (options: Options<GetBotsByBotIdTelegramStickersByStickerIdPreviewData>) => createQueryKey('getBotsByBotIdTelegramStickersByStickerIdPreview', options);

/**
 * Preview a Telegram sticker
 *
 * Return a static preview for one configured Telegram sticker
 */
export const getBotsByBotIdTelegramStickersByStickerIdPreviewQuery = defineQueryOptions<Options<GetBotsByBotIdTelegramStickersByStickerIdPreviewData>, unknown, GetBotsByBotIdTelegramStickersByStickerIdPreviewError>((options: Options<GetBotsByBotIdTelegramStickersByStickerIdPreviewData>) => ({
    key: getBotsByBotIdTelegramStickersByStickerIdPreviewQueryKey(options),
    query: async (context) => {
        const { data } = await getBotsByBotIdTelegramStickersByStickerIdPreview({
            ...options,
            ...context,
            throwOnError: true
        });
...
/**
 * Retry Telegram sticker recognition
 *
 * Clear a failed visual-description cache entry and recognize the sticker again
 */
export const postBotsByBotIdTelegramStickersByStickerIdRetryMutation = (options?: Partial<Options<PostBotsByBotIdTelegramStickersByStickerIdRetryData>>): UseMutationOptions<PostBotsByBotIdTelegramStickersByStickerIdRetryResponse, Options<PostBotsByBotIdTelegramStickersByStickerIdRetryData>, PostBotsByBotIdTelegramStickersByStickerIdRetryError> => ({
    mutation: async (vars) => {
        const { data } = await postBotsByBotIdTelegramStickersByStickerIdRetry({
            ...options,
            ...vars,
            throwOnError: true
        });
...
export const getBotsByBotIdToolsCatalogQueryKey = (options: Options<GetBotsByBotIdToolsCatalogData>) => createQueryKey('getBotsByBotIdToolsCatalog', options);

/**
 * List tools available for channel configuration
 *
 * Lists the tools the bot can currently expose before applying its manual channel allowlist.
 */
export const getBotsByBotIdToolsCatalogQuery = defineQueryOptions<Options<GetBotsByBotIdToolsCatalogData>, GetBotsByBotIdToolsCatalogResponse, GetBotsByBotIdToolsCatalogError>((options: Options<GetBotsByBotIdToolsCatalogData>) => ({
    key: getBotsByBotIdToolsCatalogQueryKey(options),
    query: async (context) => {
