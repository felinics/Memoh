...
export const getBotsByBotIdSessionsBySessionIdContextTrajectoryQueryKey = (options: Options<GetBotsByBotIdSessionsBySessionIdContextTrajectoryData>) => createQueryKey('getBotsByBotIdSessionsBySessionIdContextTrajectory', options);

/**
 * List context assembly stages and provider requests
 *
 * Read ordered, content-light capture metadata independently of conversation messages. Full captured content is available on demand with workspace_read. A capture_id distinguishes continuations that reuse a run_id; capture_errors reports preceding capture failures
 */
export const getBotsByBotIdSessionsBySessionIdContextTrajectoryQuery = defineQueryOptions<Options<GetBotsByBotIdSessionsBySessionIdContextTrajectoryData>, GetBotsByBotIdSessionsBySessionIdContextTrajectoryResponse, GetBotsByBotIdSessionsBySessionIdContextTrajectoryError>((options: Options<GetBotsByBotIdSessionsBySessionIdContextTrajectoryData>) => ({
    key: getBotsByBotIdSessionsBySessionIdContextTrajectoryQueryKey(options),
    query: async (context) => {
...
export const getBotsByBotIdSessionsBySessionIdContextTrajectoryByEventIdQueryKey = (options: Options<GetBotsByBotIdSessionsBySessionIdContextTrajectoryByEventIdData>) => createQueryKey('getBotsByBotIdSessionsBySessionIdContextTrajectoryByEventId', options);

/**
 * Read the complete content of a context assembly stage
 *
 * Reassemble full captured blocks in their original order, verifying byte counts and hashes. Requires workspace_read in addition to session access. Missing or corrupt blocks are explicitly unavailable; complete is false when any block cannot be restored. Non-UTF-8 bytes use base64 encoding
 */
export const getBotsByBotIdSessionsBySessionIdContextTrajectoryByEventIdQuery = defineQueryOptions<Options<GetBotsByBotIdSessionsBySessionIdContextTrajectoryByEventIdData>, GetBotsByBotIdSessionsBySessionIdContextTrajectoryByEventIdResponse, GetBotsByBotIdSessionsBySessionIdContextTrajectoryByEventIdError>((options: Options<GetBotsByBotIdSessionsBySessionIdContextTrajectoryByEventIdData>) => ({
    key: getBotsByBotIdSessionsBySessionIdContextTrajectoryByEventIdQueryKey(options),
    query: async (context) => {
