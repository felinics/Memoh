...
export const getBotsByBotIdProjectsQueryKey = (options: Options<GetBotsByBotIdProjectsData>) => createQueryKey('getBotsByBotIdProjects', options);

/**
 * List a Bot's projects
 */
export const getBotsByBotIdProjectsQuery = defineQueryOptions<Options<GetBotsByBotIdProjectsData>, GetBotsByBotIdProjectsResponse, GetBotsByBotIdProjectsError>((options: Options<GetBotsByBotIdProjectsData>) => ({
    key: getBotsByBotIdProjectsQueryKey(options),
    query: async (context) => {
 ...
 *
 * Registers a named project directory on a workspace target. The directory must already exist on that target.
 */
export const postBotsByBotIdProjectsMutation = (options?: Partial<Options<PostBotsByBotIdProjectsData>>): UseMutationOptions<PostBotsByBotIdProjectsResponse, Options<PostBotsByBotIdProjectsData>, PostBotsByBotIdProjectsError> => ({
    mutation: async (vars) => {
...
/**
 * Archive a Bot project
 *
 * Archiving refuses new session bindings but keeps existing sessions working: their directory never changes underneath them.
 */
export const deleteBotsByBotIdProjectsByProjectIdMutation = (options?: Partial<Options<DeleteBotsByBotIdProjectsByProjectIdData>>): UseMutationOptions<unknown, Options<DeleteBotsByBotIdProjectsByProjectIdData>, DeleteBotsByBotIdProjectsByProjectIdError> => ({
    mutation: async (vars) => {
        const { data } = await deleteBotsByBotIdProjectsByProjectId({
            ...options,
            ...vars,
            throwOnError: true
        });
...
/**
 * Rename a Bot project
 *
 * Only the name can change. The target and path are immutable: they are baked into the working directory of every session bound to this project.
 */
export const patchBotsByBotIdProjectsByProjectIdMutation = (options?: Partial<Options<PatchBotsByBotIdProjectsByProjectIdData>>): UseMutationOptions<PatchBotsByBotIdProjectsByProjectIdResponse, Options<PatchBotsByBotIdProjectsByProjectIdData>, PatchBotsByBotIdProjectsByProjectIdError> => ({
    mutation: async (vars) => {
