import { createLucideIcon, Paperclip, Monitor, Terminal, Globe, Columns2, Rows2 } from 'lucide-vue-next'

// Heroicons cog-8-tooth; path data preserved from optimized/24/outline.
// MIT license: ./LICENSE.heroicons. Host components choose the rendered size and stroke.
...
export const ConnectorIcon = createLucideIcon('Connector', [
...
export const UploadIcon = Paperclip
// Monitor and cloud silhouette, composed in the shared 24-unit icon frame.
export const CloudIcon = createLucideIcon('CloudComputer', [
...
export const ComputerIcon = Monitor

export const TerminalIcon = Terminal
export const BrowserIcon = Globe
export const SplitRightIcon = Columns2
export const SplitDownIcon = Rows2
