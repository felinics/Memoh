...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/bots/{bot_id}/projects/{project_id}": {
            "delete": {
        ...
        "/bots/{bot_id}/sessions": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Only include sessions bound to this project. The literal none selects sessions with no project.",
                        "name": "project_id",
                        "in": "query"
                    },
                    {
