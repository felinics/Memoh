...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.TelegramStickerCatalog"
                        }
                    },
                    "503": {
                        "description": "Service Unavailable",
        ...
        "/bots/{bot_id}/telegram/stickers/refresh": {
            "post": {
        ...
        "/bots/{bot_id}/telegram/stickers/sets": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Sticker Set names",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.UpdateTelegramStickerSetsRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/bots/{bot_id}/telegram/stickers/{sticker_id}/preview": {
            "get": {
        ...
        "/bots/{bot_id}/telegram/stickers/{sticker_id}/retry": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.TelegramStickerCatalogEntry"
                        }
                    },
                    "404": {
                        "description": "Not Found",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.ToolCatalogResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
    ...
    "definitions": {
        ...
        "handlers.TelegramStickerCatalog": {
            "type": "object",
            "properties": {
                "failed_count": {
                    "type": "integer"
                ...
                "recognition_model_inherited": {
                    "type": "boolean"
                },
                "sets": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/handlers.TelegramStickerSetCatalog"
                    }
                },
                "stickers": {
                    "type": "array",
        ...
        "handlers.TelegramStickerCatalogEntry": {
            "type": "object",
            "properties": {
                "attempts": {
                    "type": "integer"
        ...
        "handlers.TelegramStickerSetCatalog": {
            "type": "object",
            "properties": {
                "failed_count": {
                    "type": "integer"
        ...
        "handlers.ToolCatalogResponse": {
            "type": "object",
            "properties": {
                "tools": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/handlers.ToolCatalogItem"
                    }
                }
            }
        },
        ...
        "handlers.UpdateTelegramStickerSetsRequest": {
            "type": "object",
            "properties": {
                "names": {
                    "type": "array",
        ...
        "settings.Settings": {
            ...
            "properties": {
                ...
                "telegram_sticker_vision_model_id": {
                    "type": "string"
                },
                "timezone": {
                    "type": "string"
