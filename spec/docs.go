...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.BotPeerGrantListResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/bots.CreatePeerGrantRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/bots.PeerGrant"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/bots/{bot_id}/bot-access/candidates": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.BotPeerCandidateListResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/bots/{bot_id}/bot-access/{grant_id}": {
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/bots.UpdatePeerGrantRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "bots.PeerGrant": {
            ...
            "properties": {
                ...
                "subject_bot_avatar_url": {
                    "type": "string"
                },
                "subject_bot_display_name": {
                    "type": "string"
                },
                "subject_bot_id": {
                    "type": "string"
        ...
        "handlers.BotPeerCandidateListResponse": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/handlers.BotPeerCandidate"
                    }
                }
            }
        },
        "handlers.BotPeerGrantListResponse": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
