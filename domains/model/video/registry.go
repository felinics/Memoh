...
func NewRegistry() *Registry {
	r := &Registry{providers: make(map[modeldomain.ClientType]ProviderDefinition)}
...
func defaultProviderDefinitions() []ProviderDefinition {
	return []ProviderDefinition{
		{
			ClientType:  modeldomain.ClientTypeOpenRouterVideo,
		...
		{
			ClientType:  modeldomain.ClientTypeModelArkVideo,
		...
		{
			ClientType:  modeldomain.ClientTypeVolcengineVideo,
