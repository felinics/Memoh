...
type Registry struct {
	...
	ordered   []modeldomain.ClientType
}

func isTranscriptionClientType(clientType modeldomain.ClientType) bool {
	switch clientType {
	case
		modeldomain.ClientTypeOpenAITranscription,
		modeldomain.ClientTypeOpenRouterTranscription,
		modeldomain.ClientTypeElevenLabsTranscription,
		modeldomain.ClientTypeDeepgramTranscription,
		modeldomain.ClientTypeGoogleTranscription:
		return true
	default:
		return false
	}
...
func speechToTranscriptionClientType(clientType modeldomain.ClientType) modeldomain.ClientType {
	switch clientType {
	case modeldomain.ClientTypeOpenAISpeech:
		return modeldomain.ClientTypeOpenAITranscription
	case modeldomain.ClientTypeOpenRouterSpeech:
		return modeldomain.ClientTypeOpenRouterTranscription
	case modeldomain.ClientTypeElevenLabsSpeech:
		return modeldomain.ClientTypeElevenLabsTranscription
	case modeldomain.ClientTypeDeepgramSpeech:
		return modeldomain.ClientTypeDeepgramTranscription
	case modeldomain.ClientTypeGoogleSpeech:
		return modeldomain.ClientTypeGoogleTranscription
	default:
		return ""
	}
}
...
func NewRegistry() *Registry {
	r := &Registry{
		providers: make(map[modeldomain.ClientType]ProviderDefinition),
	}
...
func (r *Registry) Get(clientType modeldomain.ClientType) (ProviderDefinition, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func defaultProviderDefinitions() []ProviderDefinition {
	...
	return []ProviderDefinition{
		{
			ClientType:   modeldomain.ClientTypeEdgeSpeech,
		...
		{
			ClientType:  modeldomain.ClientTypeOpenRouterSpeech,
		...
		{
			ClientType:  modeldomain.ClientTypeElevenLabsSpeech,
		...
		{
			ClientType:  modeldomain.ClientTypeGoogleSpeech,
		...
		{
			ClientType:  modeldomain.ClientTypeDeepgramSpeech,
		...
		{
			ClientType:  modeldomain.ClientTypeMiniMaxSpeech,
		...
		{
			ClientType:  modeldomain.ClientTypeVolcengineSpeech,
		...
		{
			ClientType:  modeldomain.ClientTypeAlibabaSpeech,
		...
		{
			ClientType:  modeldomain.ClientTypeMicrosoftSpeech,
