...
func TestIsManagedModelCatalogClientType(t *testing.T) {
	...
	if !IsManagedModelCatalogClientType(modeldomain.ClientTypeOpenAICodex) {
		t.Fatal("Codex should use a managed model catalog")
	}
	if !IsManagedModelCatalogClientType(modeldomain.ClientTypeGitHubCopilot) {
		t.Fatal("GitHub Copilot should use a managed model catalog")
	}
	if IsManagedModelCatalogClientType(modeldomain.ClientTypeOpenAICompletions) {
