...
func IsManagedModelCatalogClientType(clientType modeldomain.ClientType) bool {
	return clientType == modeldomain.ClientTypeOpenAICodex || clientType == modeldomain.ClientTypeGitHubCopilot
}
