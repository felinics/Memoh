...
// streaming vocabulary (domains/agent) and UI rendering - every
...
func UIStreamEventFromAgentEvent(ev agentdomain.StreamEvent) UIMessageStreamEvent {
...
// resolve asset URLs.
func UIAttachmentFromAgentAttachment(attachment agentdomain.FileAttachment) UIAttachment {
	result := UIAttachment{
