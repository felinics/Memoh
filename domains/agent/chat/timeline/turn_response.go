...
func DecodeTurnResponseEntry(msg messagepkg.Message) (TurnResponseEntry, bool) {
	...
	var modelMsg agentdomain.ModelMessage
...
func nativeAssistantContent(msg agentdomain.ModelMessage) json.RawMessage {
...
func nativeToolRoleContent(msg agentdomain.ModelMessage) json.RawMessage {
