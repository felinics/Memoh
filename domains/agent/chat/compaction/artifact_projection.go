...
func (f ArtifactFrontier) ResolveCoveredRef(ref fragment.ContextRef) (Artifact, bool) {
...
func (f ArtifactFrontier) ResolveCoverageIdentity(ref fragment.ContextRef) (Artifact, bool) {
	covered, ok := f.coverage[ref.StableKey()]
	if !ok {
		return Artifact{}, false
	}
...
func compatibleCoverageRef(candidate fragment.ContextRef, expected fragment.ContextRef) bool {
