...
func (c *ArtifactCatalog) ResolveCoveredRef(owner ArtifactOwner, ref fragment.ContextRef) (Artifact, bool) {
	frontier, ok := c.frontiers[normalizeArtifactOwner(owner)]
	if !ok {
		return Artifact{}, false
	}
...
func (c *ArtifactCatalog) ResolveCoverageIdentity(owner ArtifactOwner, ref fragment.ContextRef) (Artifact, bool) {
	frontier, ok := c.frontiers[normalizeArtifactOwner(owner)]
	if !ok {
		return Artifact{}, false
	}
