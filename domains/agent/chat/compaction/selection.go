...
func candidatePolicies(record history.HistoryRecord) []CompactPolicy {
...
func isToolExchangeRecord(record history.HistoryRecord) bool {
...
func isAskUserRecord(record history.HistoryRecord) bool {
	mm := record.ModelMessage
...
func buildEntriesAndIDs(items []CompactionCandidate) ([]messageEntry, []string) {
