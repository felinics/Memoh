...
func renderCandidateEntry(record history.HistoryRecord) string {
...
func renderEntryHeader(record history.HistoryRecord) string {
	var lines []string
...
// raw stored JSON.
func renderEntryContent(mm agentdomain.ModelMessage) string {
