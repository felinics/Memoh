...
func (e ToolStreamEvent) ToAgentStreamEvent() (agentdomain.StreamEvent, bool) {
	typ := agentdomain.StreamEventType(strings.TrimSpace(e.Type))
	switch typ {
	case agentdomain.ToolCallStart, agentdomain.ToolCallEnd:
	...
	default:
		return agentdomain.StreamEvent{}, false
	}
}
