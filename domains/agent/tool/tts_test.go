...
func (ttsTestSettings) GetBot(context.Context, string) (setting.Settings, error) {
	return setting.Settings{TtsModelID: "tts-model-1"}, nil
}
...
func (s *ttsRecordingSender) Send(_ context.Context, _ string, _ delivery.Platform, req delivery.SendRequest) error {
	s.called++
	s.req = req
	return nil
}
