...
import (
	...
	workspacepkg "github.com/memohai/memoh/domains/runtime/workspace"
)
...
func (s *largeReadTestContainerService) Stat(_ context.Context, req *bridgepb.StatRequest) (*bridgepb.StatResponse, error) {
...
func newLargeReadTestClient(t *testing.T, size int64) *bridge.Client {
	...
	srv := grpc.NewServer()
	bridgepb.RegisterContainerServiceServer(srv, &largeReadTestContainerService{size: size})
