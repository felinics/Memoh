...
func TestImageGenerationRouting(t *testing.T) {
	...
	openAICompletions := string(modeldomain.ClientTypeOpenAICompletions)
	...
	if !shouldUseOpenAIImagesGeneration(string(modeldomain.ClientTypeOpenAIResponses), "https://api.openai.com/v1", "gpt-image-1") {
	...
	if shouldUseOpenAIImagesGeneration(string(modeldomain.ClientTypeAnthropicMessages), "https://api.openai.com/v1", "gpt-image-1") {
