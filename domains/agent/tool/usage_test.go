...
func (usageTestResolver) ParseChannelType(raw string) (delivery.Platform, error) {
	return delivery.Platform(raw), nil
}

type usageTestSender struct{}

func (usageTestSender) Send(context.Context, string, delivery.Platform, delivery.SendRequest) error {
	return nil
}

type usageTestReactor struct{}

func (usageTestReactor) React(context.Context, string, delivery.Platform, delivery.ReactRequest) error {
	return nil
}
