...
func validEffort(v string) bool {
	switch v {
	case modeldomain.ReasoningEffortNone, modeldomain.ReasoningEffortLow, modeldomain.ReasoningEffortMedium, modeldomain.ReasoningEffortHigh, modeldomain.ReasoningEffortXHigh:
		return true
	}
	return false
}
