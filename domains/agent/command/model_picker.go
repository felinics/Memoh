...
func (h *Handler) buildModelCandidates(cc CommandContext, items []modelcatalog.GetResponse) []modelCandidate {
...
func formatReasoningLabel(cc CommandContext, s setting.Settings) string {
