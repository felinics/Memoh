...
func (q *Queries) CreateSubagentConfig(ctx context.Context, arg CreateSubagentConfigParams) (AgentSubagentConfig, error) {
...
func (q *Queries) GetSubagentConfig(ctx context.Context, sessionID pgtype.UUID) (AgentSubagentConfig, error) {
