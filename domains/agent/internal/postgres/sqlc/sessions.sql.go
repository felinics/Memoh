...
RETURNING id, bot_id, route_id, channel_type, conversation_type, conversation_name, reply_target, type, session_mode, runtime_type, runtime_metadata, title, metadata, next_turn_position, compaction_epoch, runtime_fencing_token, parent_session_id, created_by_user_id, created_at, updated_at, deleted_at, team_id
`
...
func (q *Queries) CreateSession(ctx context.Context, arg CreateSessionParams) (AgentBotSession, error) {
...
WITH source_session AS (
  SELECT s.id, s.bot_id, s.route_id, s.channel_type, s.conversation_type, s.conversation_name, s.reply_target, s.type, s.session_mode, s.runtime_type, s.runtime_metadata, s.title, s.metadata, s.next_turn_position, s.compaction_epoch, s.runtime_fencing_token, s.parent_session_id, s.created_by_user_id, s.created_at, s.updated_at, s.deleted_at, s.team_id
...
SELECT id, bot_id, route_id, channel_type, conversation_type, conversation_name, reply_target, type, session_mode, runtime_type, runtime_metadata, title, metadata, next_turn_position, compaction_epoch, runtime_fencing_token, parent_session_id, created_by_user_id, created_at, updated_at, deleted_at, team_id
...
func (q *Queries) GetSessionByID(ctx context.Context, id pgtype.UUID) (AgentBotSession, error) {
...
func (q *Queries) ListSessionsByRoute(ctx context.Context, routeID pgtype.UUID) ([]AgentBotSession, error) {
	rows, err := q.db.Query(ctx, listSessionsByRoute, routeID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	var items []AgentBotSession
	for rows.Next() {
		var i AgentBotSession
		if err := rows.Scan(
			&i.ID,
...
func (q *Queries) ListSubagentSessionsByParent(ctx context.Context, parentSessionID pgtype.UUID) ([]AgentBotSession, error) {
...
const lockSessionForRouteAssignment = `-- name: LockSessionForRouteAssignment :one
SELECT id
FROM agent.bot_sessions
WHERE team_id = iam.memoh_current_team_id()
  AND id = $1
...
func (q *Queries) LockSessionForRouteAssignment(ctx context.Context, sessionID pgtype.UUID) (pgtype.UUID, error) {
	row := q.db.QueryRow(ctx, lockSessionForRouteAssignment, sessionID)
	var id pgtype.UUID
	err := row.Scan(&id)
	return id, err
}
...
const lockSessionsByRoute = `-- name: LockSessionsByRoute :many
SELECT id
FROM agent.bot_sessions
WHERE team_id = iam.memoh_current_team_id()
  AND route_id = $1
...
func (q *Queries) LockSessionsByRoute(ctx context.Context, routeID pgtype.UUID) ([]pgtype.UUID, error) {
	rows, err := q.db.Query(ctx, lockSessionsByRoute, routeID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
WHERE team_id = iam.memoh_current_team_id() AND id = $1 AND deleted_at IS NULL
`
...
UPDATE agent.bot_sessions
SET deleted_at = now(), updated_at = now()
WHERE team_id = iam.memoh_current_team_id() AND bot_id = $1 AND deleted_at IS NULL
`
...
WHERE team_id = iam.memoh_current_team_id() AND id = $2 AND deleted_at IS NULL
RETURNING id, bot_id, route_id, channel_type, conversation_type, conversation_name, reply_target, type, session_mode, runtime_type, runtime_metadata, title, metadata, next_turn_position, compaction_epoch, runtime_fencing_token, parent_session_id, created_by_user_id, created_at, updated_at, deleted_at, team_id
`
...
func (q *Queries) UpdateSessionMetadata(ctx context.Context, arg UpdateSessionMetadataParams) (AgentBotSession, error) {
...
func (q *Queries) UpdateSessionMetadataWithRuntimeFence(ctx context.Context, arg UpdateSessionMetadataWithRuntimeFenceParams) (AgentBotSession, error) {
...
func (q *Queries) UpdateSessionTitle(ctx context.Context, arg UpdateSessionTitleParams) (AgentBotSession, error) {
...
func (q *Queries) UpdateSessionTitleWithRuntimeFence(ctx context.Context, arg UpdateSessionTitleWithRuntimeFenceParams) (AgentBotSession, error) {
...
SET type = $1,
    ...
    metadata = $5,
    updated_at = now()
WHERE team_id = iam.memoh_current_team_id() AND id = $6 AND deleted_at IS NULL
RETURNING id, bot_id, route_id, channel_type, conversation_type, conversation_name, reply_target, type, session_mode, runtime_type, runtime_metadata, title, metadata, next_turn_position, compaction_epoch, runtime_fencing_token, parent_session_id, created_by_user_id, created_at, updated_at, deleted_at, team_id
`
...
func (q *Queries) UpdateSessionTypeAndMetadata(ctx context.Context, arg UpdateSessionTypeAndMetadataParams) (AgentBotSession, error) {
