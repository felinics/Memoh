...
func (q *Queries) CompleteCompactionLog(ctx context.Context, arg CompleteCompactionLogParams) (AgentBotHistoryMessageCompact, error) {
	...
	var i AgentBotHistoryMessageCompact
	err := row.Scan(
		&i.ID,
		&i.BotID,
		&i.SessionID,
...
func (q *Queries) CreateCompactionLog(ctx context.Context, arg CreateCompactionLogParams) (AgentBotHistoryMessageCompact, error) {
...
func (q *Queries) GetCompactionLogByID(ctx context.Context, id pgtype.UUID) (AgentBotHistoryMessageCompact, error) {
...
func (q *Queries) ListCompactionArtifactLineageBySession(ctx context.Context, id pgtype.UUID) ([]AgentBotHistoryMessageCompact, error) {
	rows, err := q.db.Query(ctx, listCompactionArtifactLineageBySession, id)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	var items []AgentBotHistoryMessageCompact
	for rows.Next() {
		var i AgentBotHistoryMessageCompact
		if err := rows.Scan(
			&i.ID,
...
func (q *Queries) ListCompactionLogsByBot(ctx context.Context, arg ListCompactionLogsByBotParams) ([]AgentBotHistoryMessageCompact, error) {
