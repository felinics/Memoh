...
func (q *Queries) GetMCPOAuthToken(ctx context.Context, connectionID pgtype.UUID) (AgentMcpOauthToken, error) {
	row := q.db.QueryRow(ctx, getMCPOAuthToken, connectionID)
	var i AgentMcpOauthToken
	err := row.Scan(
		&i.ID,
		&i.ConnectionID,
...
func (q *Queries) GetMCPOAuthTokenByState(ctx context.Context, stateParam string) (AgentMcpOauthToken, error) {
...
func (q *Queries) UpsertMCPOAuthDiscovery(ctx context.Context, arg UpsertMCPOAuthDiscoveryParams) (AgentMcpOauthToken, error) {
