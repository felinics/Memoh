...
func TestSubmittedResultBuildsAnswers(t *testing.T) {
	...
	result, err := submittedResult(selectPayload(), []agentdomain.QuestionAnswer{
...
func TestSubmittedResultValidation(t *testing.T) {
	...
	cases := []struct {
		...
		{"missing answer", []agentdomain.QuestionAnswer{
			{QuestionID: "q1", OptionIDs: []string{"q1.o1"}},
			{QuestionID: "q2", OptionIDs: []string{"q2.o1"}},
		}},
		{"unknown question", []agentdomain.QuestionAnswer{
			{QuestionID: "q9", OptionIDs: []string{"q1.o1"}},
		}},
		{"duplicate answer", []agentdomain.QuestionAnswer{
			{QuestionID: "q1", OptionIDs: []string{"q1.o1"}},
			{QuestionID: "q1", OptionIDs: []string{"q1.o2"}},
			{QuestionID: "q2", OptionIDs: []string{"q2.o1"}},
			{QuestionID: "q3", Text: "ok"},
		}},
		{"unknown option", []agentdomain.QuestionAnswer{
			{QuestionID: "q1", OptionIDs: []string{"nope"}},
			{QuestionID: "q2", OptionIDs: []string{"q2.o1"}},
			{QuestionID: "q3", Text: "ok"},
		}},
		{"multiple options on single select", []agentdomain.QuestionAnswer{
			{QuestionID: "q1", OptionIDs: []string{"q1.o1", "q1.o2"}},
			{QuestionID: "q2", OptionIDs: []string{"q2.o1"}},
			{QuestionID: "q3", Text: "ok"},
		}},
		{"option and custom on single select", []agentdomain.QuestionAnswer{
			{QuestionID: "q1", OptionIDs: []string{"q1.o1"}, CustomText: "extra"},
			{QuestionID: "q2", OptionIDs: []string{"q2.o1"}},
			{QuestionID: "q3", Text: "ok"},
		}},
		{"custom text without allow_custom", []agentdomain.QuestionAnswer{
			{QuestionID: "q1", OptionIDs: []string{"q1.o1"}},
			{QuestionID: "q2", CustomText: "extra"},
			{QuestionID: "q3", Text: "ok"},
		}},
		{"empty selection", []agentdomain.QuestionAnswer{
			{QuestionID: "q1"},
			{QuestionID: "q2", OptionIDs: []string{"q2.o1"}},
			{QuestionID: "q3", Text: "ok"},
		}},
		{"text on select question", []agentdomain.QuestionAnswer{
			{QuestionID: "q1", Text: "Plan A"},
			{QuestionID: "q2", OptionIDs: []string{"q2.o1"}},
			{QuestionID: "q3", Text: "ok"},
		}},
		{"skipped with answer", []agentdomain.QuestionAnswer{
			{QuestionID: "q1", OptionIDs: []string{"q1.o1"}},
