...
// SpawnAdapter wraps *Agent to satisfy tool.SpawnAgent without creating
...
func (s *SpawnAdapter) Generate(ctx context.Context, cfg tool.SpawnRunConfig) (*tool.SpawnResult, error) {
...
func runConfigFromSpawnRunConfig(cfg tool.SpawnRunConfig) RunConfig {
...
func (s *SpawnAdapter) GenerateWithWatchdog(ctx context.Context, cfg tool.SpawnRunConfig, touchFn func()) (*tool.SpawnResult, error) {
	rc := runConfigFromSpawnRunConfig(cfg)
