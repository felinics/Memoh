...
func sanitizeMessages(messages []agentdomain.ModelMessage) []agentdomain.ModelMessage {
	cleaned := make([]agentdomain.ModelMessage, 0, len(messages))
...
func normalizeImagePartsToDataURL(msg agentdomain.ModelMessage) (agentdomain.ModelMessage, bool) {
...
func nonNilModelMessages(m []agentdomain.ModelMessage) []agentdomain.ModelMessage {
	if m == nil {
