...
func (s *Service) prepareWorkspaceRequest(ctx context.Context, req ChatRequest) (context.Context, ChatRequest, error) {
	...
	if requestedTargetID != "" {
		...
		allowed, err := s.botPermissions.HasBotPermission(ctx, req.BotID, req.UserID, bot.PermissionWorkspaceRead)
		if err != nil {
...
func workspaceTargetFromRunConfig(cfg engine.RunConfig) *WorkspaceTarget {
