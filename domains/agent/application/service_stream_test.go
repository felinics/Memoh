...
func TestHasVisibleAgentStreamOutputIgnoresLifecycleOnlyEvents(t *testing.T) {
	...
	cases := []agentdomain.StreamEvent{
		{Type: agentdomain.TextStart},
		{Type: agentdomain.TextDelta, Delta: "  \n\t"},
		{Type: agentdomain.TextEnd},
		{Type: agentdomain.ReasoningStart},
		{Type: agentdomain.ReasoningDelta, Delta: ""},
		{Type: agentdomain.ReasoningEnd},
	...
	visible := []agentdomain.StreamEvent{
		{Type: agentdomain.TextDelta, Delta: "hello"},
		{Type: agentdomain.ReasoningDelta, Delta: "thinking"},
		{Type: agentdomain.AttachmentDelta, Attachments: []agentdomain.FileAttachment{{Path: "/tmp/a.png"}}},
...
func TestPersistTerminalSnapshotSkillActivationWithoutPromptDoesNotStoreModelMarker(t *testing.T) {
	...
	req := ChatRequest{
		BotID:                "bot-1",
		ThreadID:             "session-1",
		ModelQuery:           agentdomain.SkillActivationModelQuery(activation),
	...
	if user.Metadata["user_message_kind"] != agentdomain.UserMessageKindSkillActivation {
