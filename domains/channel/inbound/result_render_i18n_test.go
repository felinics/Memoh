...
func TestRenderChromeLocalizedButTokensPreserved(t *testing.T) {
	...
	zh := renderResult(res, RenderContext{Caps: gateway.ChannelCapabilities{Buttons: true, Markdown: true}, T: i18n.New("zh")})
...
func TestRenderListNavChromeZh(t *testing.T) {
	...
	zh := renderResult(res, RenderContext{Caps: gateway.ChannelCapabilities{Buttons: true}, T: i18n.New("zh")})
...
func TestNoButtonChannelKeepsCopyableFallback(t *testing.T) {
	...
	plain := renderResult(res, RenderContext{Caps: gateway.ChannelCapabilities{}, T: i18n.New("zh")})
