// Package fixture exposes the canonical Message.Parts fixture used by
...
func Canonical() []gateway.MessagePart {
	return []gateway.MessagePart{
		...
		{Type: gateway.MessagePartText, Text: "world", Styles: []gateway.MessageTextStyle{gateway.MessageStyleItalic}},
		{Type: gateway.MessagePartLink, Text: "docs", URL: "https://example.test/page"},
		{Type: gateway.MessagePartLink, Text: "wiki", URL: "https://example.test/<x>(y)|z"},
		{Type: gateway.MessagePartLink, Text: "empty url"},
		{Type: gateway.MessagePartLink, Text: "evil", URL: "javascript:alert(1)"},
		{Type: gateway.MessagePartText, Text: "literal.code", Styles: []gateway.MessageTextStyle{gateway.MessageStyleCode, gateway.MessageStyleBold}},
		{Type: gateway.MessagePartCodeBlock, Text: "go test", Language: "bash"},
		{Type: gateway.MessagePartCodeBlock, Text: "line1\nline2", Language: "python"},
