...
func parseConfig(raw map[string]any) (Config, error) {
	cfg := Config{
		...
		Token:          strings.TrimSpace(gateway.ReadString(raw, "token")),
...
func parseUserConfig(raw map[string]any) (UserConfig, error) {
	cfg := UserConfig{
		...
		UnionID: strings.TrimSpace(gateway.ReadString(raw, "unionid", "union_id")),
	}
...
func matchBinding(config map[string]any, criteria gateway.BindingCriteria) bool {
