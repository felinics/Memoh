...
func NewQRHandler(log *slog.Logger, lifecycle *gateway.Lifecycle) *QRHandler {
	if log == nil {
		log = slog.Default()
	}
	return &QRHandler{
...
func NewQRServerHandler(log *slog.Logger, lifecycle *gateway.Lifecycle) *QRHandler {
