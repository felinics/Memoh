...
func (a *FeishuAdapter) enrichSenderProfile(ctx context.Context, cfg gateway.ChannelConfig, event *larkim.P2MessageReceiveV1, msg *gateway.InboundMessage) {
	if msg == nil {
		return
	}
...
func (*FeishuAdapter) lookupSenderProfile(ctx context.Context, cfg gateway.ChannelConfig, openID, userID, chatID string) (feishuSenderProfile, error) {
...
func applySenderProfile(msg *gateway.InboundMessage, profile feishuSenderProfile) {
	if msg == nil {
		return
	}
