...
func (a *FeishuAdapter) enrichQuotedMessage(ctx context.Context, cfg gateway.ChannelConfig, msg *gateway.InboundMessage, botOpenID string) {
...
func feishuQuotedAttachments(msg *larkim.Message) ([]gateway.Attachment, bool) {
	if msg == nil || msg.Body == nil || msg.Body.Content == nil {
		return nil, false
	}
	content := strings.TrimSpace(*msg.Body.Content)
	...
	case larkim.MsgTypeImage:
		...
		return []gateway.Attachment{gateway.NormalizeInboundChannelAttachment(gateway.Attachment{
