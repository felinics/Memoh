...
func (m *fakeWebhookManager) HandleInbound(_ context.Context, cfg gateway.ChannelConfig, msg gateway.InboundMessage) error {
...
func newWebhookConfig(credentials map[string]any) gateway.ChannelConfig {
