...
func TestObservedConversationReaderComposesOwnerProjections(t *testing.T) {
	...
	items, err := reader.ListObservedConversations(t.Context(), acl.ObservedConversationQuery{
...
func TestObservedConversationReaderForwardsChannelTypeToChannelOwner(t *testing.T) {
	...
	_, err := reader.ListObservedConversations(t.Context(), acl.ObservedConversationQuery{
