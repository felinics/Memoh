...
type backupHistory struct {
	Sessions            []chatbackup.Session          `json:"sessions,omitempty"`
	Messages            []chatbackup.Message          `json:"messages,omitempty"`
	DiscussCursors      []channelbackup.DiscussCursor `json:"discuss_cursors,omitempty"`
	SessionEvents       []channelbackup.SessionEvent  `json:"session_events,omitempty"`
	RouteActiveSessions []backupRouteActiveSession    `json:"route_active_sessions,omitempty"`
	Assets              []chatbackup.Asset            `json:"assets,omitempty"`
}

type backupRouteActiveSession struct {
