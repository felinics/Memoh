...
// NewChannelIdentityBindingStore adapts API-owned outbound delivery bindings
// to the Channel consumer port.
func NewChannelIdentityBindingStore(pool *pgxpool.Pool) gateway.IdentityBindingStore {
