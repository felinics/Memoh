...
func (p *recordingMemoryProvider) Update(_ context.Context, req memprovider.UpdateRequest) (memorydomain.Item, error) {
	p.updateCalls = append(p.updateCalls, req.MemoryID)
	return memorydomain.Item{ID: req.MemoryID}, nil
}
