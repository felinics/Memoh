...
func NewBotStore(record botpersistence.Record, permissions ...[]byte) *BotStore {
...
func (s *BotStore) GetBotByID(_ context.Context, botID string) (botpersistence.Record, error) {
	if s.Bot.ID != "" && s.Bot.ID != botID {
		return botpersistence.Record{}, botpersistence.ErrBotNotFound
	}
	return s.Bot, nil
}

func (s *BotStore) GetBotByName(_ context.Context, name string) (botpersistence.Record, error) {
...
func (s *BotStore) ListBotsByOwner(context.Context, string) ([]botpersistence.Record, error) {
	return []botpersistence.Record{s.Bot}, nil
}

func (s *BotStore) ListAccessibleBots(context.Context, string) ([]botpersistence.Record, error) {
	return []botpersistence.Record{s.Bot}, nil
}

func (s *BotStore) CreateBot(_ context.Context, input botpersistence.CreateInput) (botpersistence.Record, error) {
	id := s.CreateID
	if id == "" {
		id = "22222222-2222-2222-2222-222222222222"
	}
	s.Bot = botpersistence.Record{
		ID:          id,
...
func (s *BotStore) UpdateBot(_ context.Context, input botpersistence.UpdateInput) (botpersistence.Record, error) {
...
func (s *BotStore) UpdateBotOwner(_ context.Context, _, ownerUserID string) (botpersistence.Record, error) {
...
func (*BotStore) ListGrants(context.Context, string) ([]botpersistence.GrantRecord, error) {
	return nil, nil
}

func (s *BotStore) ListGrantsForUser(_ context.Context, botID, userID string) ([]botpersistence.GrantRecord, error) {
...
func (*BotStore) GetGrant(context.Context, string) (botpersistence.GrantRecord, error) {
	return botpersistence.GrantRecord{}, botpersistence.ErrGrantNotFound
}

func (*BotStore) CreateGrant(context.Context, botpersistence.CreateGrantInput) (botpersistence.GrantRecord, error) {
	return botpersistence.GrantRecord{}, nil
}

func (*BotStore) UpdateGrantPermissions(context.Context, string, []byte) (botpersistence.GrantRecord, error) {
	return botpersistence.GrantRecord{}, botpersistence.ErrGrantNotFound
}
...
func (stubUserReader) GetUser(_ context.Context, userID string) (botpersistence.UserRecord, error) {
	return botpersistence.UserRecord{ID: userID, Username: "user"}, nil
}

type stubContainerReader struct{}

func (stubContainerReader) GetContainerByBotID(context.Context, string) (botpersistence.ContainerRecord, error) {
