...
func NewMCPOAuthHandler(log *slog.Logger, oauthService *mcp.OAuthService, connService *mcp.ConnectionService, botService *bot.Service, accountService *account.Service) *MCPOAuthHandler {
...
func (h *MCPOAuthHandler) authorizeBotAccess(ctx context.Context, channelIdentityID, botID string) (bot.Bot, error) {
...
<html>
  ...
  <body style="font-family: sans-serif; padding: 24px;">
	...
	return c.HTML(status, httpx.ExecuteHTMLTemplate(page, map[string]string{
		"Result":  result,
		"Message": message,
	}))
}
