...
func NewScheduleHandler(log *slog.Logger, service *schedule.Service, botService *bot.Service, accountService *account.Service) *ScheduleHandler {
...
func (h *ScheduleHandler) authorizeBotAccess(ctx context.Context, userID, botID string) (bot.Bot, error) {
