...
func NewProviderTemplatesHandler(service *template.Service) *ProviderTemplatesHandler {
...
// @Success 200 {array} template.GetResponse
...
// @Success 200 {object} template.GetResponse
