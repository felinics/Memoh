...
func (q *Queries) GetBotChannelAdmin(ctx context.Context, arg GetBotChannelAdminParams) (ApiBotChannelAdmin, error) {
	row := q.db.QueryRow(ctx, getBotChannelAdmin, arg.BotID, arg.ChannelIdentityID)
	var i ApiBotChannelAdmin
	err := row.Scan(
		&i.ID,
		&i.BotID,
		&i.ChannelIdentityID,
...
func (q *Queries) UpsertBotChannelAdmin(ctx context.Context, arg UpsertBotChannelAdminParams) (ApiBotChannelAdmin, error) {
