...
func (q *Queries) CreateBotUserGrant(ctx context.Context, arg CreateBotUserGrantParams) (ApiBotUserGrant, error) {
...
func (q *Queries) GetBotUserGrantByID(ctx context.Context, id pgtype.UUID) (ApiBotUserGrant, error) {
...
func (q *Queries) UpdateBotUserGrantPermissions(ctx context.Context, arg UpdateBotUserGrantPermissionsParams) (ApiBotUserGrant, error) {
