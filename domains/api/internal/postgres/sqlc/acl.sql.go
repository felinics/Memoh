...
func (q *Queries) CreateBotACLRule(ctx context.Context, arg CreateBotACLRuleParams) (ApiBotAclRule, error) {
...
FROM api.bots b
WHERE b.team_id = iam.memoh_current_team_id() AND b.id = $7
`
...
func (q *Queries) UpdateBotACLRule(ctx context.Context, arg UpdateBotACLRuleParams) (ApiBotAclRule, error) {
