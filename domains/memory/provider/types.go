...
//
// It lives with the provider contract rather than with the registry because
// provider runtimes bind a resolver at construction time, and the registry
// depends on providers, not the reverse.
