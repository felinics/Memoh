...
type ingestFakeStore struct {
	items []memorydomain.Item
}

func (*ingestFakeStore) PersistMemories(context.Context, string, []memorydomain.Item, map[string]any) error {
	return nil
}

func (s *ingestFakeStore) ReadAllMemoryFiles(context.Context, string) ([]memorydomain.Item, error) {
...
func (s *ingestFakeStore) ReadAllMemoryFilesForIngest(context.Context, string) ([]memorydomain.Item, error) {
...
func (*ingestFakeStore) RebuildFiles(context.Context, string, []memorydomain.Item, map[string]any) error {
	return nil
}
...
func TestIngestMarkdownFiles(t *testing.T) {
	...
	fs := &ingestFakeStore{items: []memorydomain.Item{
...
func TestIngestLayerClassification(t *testing.T) {
	...
	want := map[string]memorydomain.Layer{
		"bot-l:mem_pref": memorydomain.LayerPreference,
		"bot-l:mem_id":   memorydomain.LayerIdentity,
		"bot-l:mem_note": memorydomain.LayerNote,
	}
