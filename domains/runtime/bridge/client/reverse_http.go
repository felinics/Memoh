...
func (c *Client) ServeReverseHTTPRoute(ctx context.Context, route string, handler http.Handler) (func(), error) {
	...
	sendFrame := func(frame *bridgepb.ReverseHTTPFrame) error {
...
func serveReverseHTTPRequest(ctx context.Context, handler http.Handler, sendFrame func(*bridgepb.ReverseHTTPFrame) error, request *bridgepb.ReverseHTTPRequest) {
	response, err := handleReverseHTTPRequest(ctx, handler, request)
	if err != nil {
		_ = sendFrame(&bridgepb.ReverseHTTPFrame{
	...
	_ = sendFrame(&bridgepb.ReverseHTTPFrame{
		Frame: &bridgepb.ReverseHTTPFrame_Response{Response: response},
	})
}

func handleReverseHTTPRequest(ctx context.Context, handler http.Handler, request *bridgepb.ReverseHTTPRequest) (*bridgepb.ReverseHTTPResponse, error) {
	...
	return &bridgepb.ReverseHTTPResponse{
		Id:         request.GetId(),
...
func copyReverseHTTPHeaders(dst http.Header, headers []*bridgepb.HTTPHeader) {
...
func reverseHTTPHeadersToProto(header http.Header) []*bridgepb.HTTPHeader {
