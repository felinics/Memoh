...
func TestExecPipePreservesExitCodeAcrossStreamCancellation(t *testing.T) {
	...
	err := srv.execPipe(stream, &bridgepb.ExecInput{
...
func TestExecPTYStartsWithCancellationConfigured(t *testing.T) {
	...
	err := srv.execPTY(stream, &bridgepb.ExecInput{
...
func collectStdout(outputs []*bridgepb.ExecOutput) string {
	var stdout strings.Builder
	for _, output := range outputs {
		if output.GetStream() == bridgepb.ExecOutput_STDOUT {
