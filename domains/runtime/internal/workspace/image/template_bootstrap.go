...
const (
	// DefaultBootstrapRoot is the container path seeded by template bootstrap.
	DefaultBootstrapRoot = "/data"

	defaultWorkspaceBootstrapRoot = DefaultBootstrapRoot
...
// BridgeFileSystem adapts a bridge client to WorkspaceFileSystem.
func BridgeFileSystem(client *bridge.Client) WorkspaceFileSystem {
	return bridgeWorkspaceFileSystem{client: client}
}
