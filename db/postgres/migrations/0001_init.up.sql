...
CREATE TABLE IF NOT EXISTS public.bot_dependency_installations (
    ...
    operation_source_url TEXT NOT NULL DEFAULT '',
    operation_registry_id TEXT NOT NULL DEFAULT '',
    operation_definition_revision TEXT NOT NULL DEFAULT '',
    operation_intent JSONB CHECK (operation_intent IS NULL OR jsonb_typeof(operation_intent) = 'object'),
    created_at          TIMESTAMPTZ NOT NULL DEFAULT now(),
    updated_at          TIMESTAMPTZ NOT NULL DEFAULT now(),
