...
-- ---------------------------------------------------------------------------
-- Workspace context materialization
-- ---------------------------------------------------------------------------
-- Hooks, Skills and prompt system files are workspace-owned source data. This
-- row stores their last validated materialization so model-only turns do not
-- need to open the workspace runtime.
