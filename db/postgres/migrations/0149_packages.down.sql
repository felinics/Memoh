-- 0149_packages
-- Drop Package installations and their references, then restore the
-- Skill-only installation table.

DROP TABLE IF EXISTS public.bot_package_connector_refs;
DROP TABLE IF EXISTS public.bot_package_dependency_refs;
DROP TABLE IF EXISTS public.bot_package_installations;
