-- 0149_apps
-- Drop App installations and their references, then restore the
-- Skill-only installation table.

DROP TABLE IF EXISTS public.bot_app_connector_refs;
DROP TABLE IF EXISTS public.bot_app_dependency_refs;
DROP TABLE IF EXISTS public.bot_app_installations;
