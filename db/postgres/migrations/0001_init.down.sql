...
DROP TABLE IF EXISTS session_follow_up_queue CASCADE;
DROP TABLE IF EXISTS session_steer_queue CASCADE;
DROP TABLE IF EXISTS session_queue_step_commits CASCADE;
