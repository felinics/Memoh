...
func (v ListMcpServerStatusResponse) MarshalJSON() ([]byte, error) {
	type plain ListMcpServerStatusResponse
	p := plain(v)
	if p.Data == nil {
		p.Data = []McpServerStatus{}
	}
...
func (v McpServerStatus) MarshalJSON() ([]byte, error) {
	type plain McpServerStatus
	p := plain(v)
	if p.ResourceTemplates == nil {
		p.ResourceTemplates = []ResourceTemplate{}
	}
	if p.Resources == nil {
		p.Resources = []Resource{}
	}
	if p.Tools == nil {
		p.Tools = map[string]Tool{}
	}
	return jsonMarshal(p)
}
...
func (v SkillDependencies) MarshalJSON() ([]byte, error) {
	type plain SkillDependencies
	p := plain(v)
	if p.Tools == nil {
		p.Tools = []SkillToolDependency{}
	}
	return jsonMarshal(p)
}
...
func (v SkillsListEntry) MarshalJSON() ([]byte, error) {
	type plain SkillsListEntry
	p := plain(v)
	if p.Errors == nil {
		p.Errors = []SkillErrorInfo{}
	}
	if p.Skills == nil {
		p.Skills = []SkillMetadata{}
	}
	return jsonMarshal(p)
}
...
func (v ThreadEnvironment) MarshalJSON() ([]byte, error) {
	type plain ThreadEnvironment
	p := plain(v)
	if p.RuntimeWorkspaceRoots == nil {
		p.RuntimeWorkspaceRoots = []LegacyAppPathString{}
	}
	return jsonMarshal(p)
}
