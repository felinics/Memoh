...
func NewResponseForMethod(method string) (resp any, ok bool) {
	...
	case "thread/goal/get":
		return new(ThreadGoalGetResponse), true
	case "thread/goal/clear":
		return new(ThreadGoalClearResponse), true
	case "thread/compact/start":
		return new(ThreadCompactStartResponse), true
	case "review/start":
		return new(ReviewStartResponse), true
	case "skills/list":
		return new(SkillsListResponse), true
	case "mcpServerStatus/list":
		return new(ListMcpServerStatusResponse), true
	case "turn/start":
...
func DecodeServerNotificationParams(method string, params []byte) (decoded any, ok bool, err error) {
	...
	case "thread/goal/updated":
		v := new(ThreadGoalUpdatedNotification)
		err = jsonUnmarshal(params, v)
		return v, true, err
	case "thread/goal/cleared":
		v := new(ThreadGoalClearedNotification)
		err = jsonUnmarshal(params, v)
		return v, true, err
	case "turn/started":
