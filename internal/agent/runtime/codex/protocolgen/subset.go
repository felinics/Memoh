...
var clientMethods = []clientMethod{
	...
	{Method: "review/start", Response: "ReviewStartResponse"},
	{Method: "skills/list", Response: "SkillsListResponse"},
	{Method: "mcpServerStatus/list", Response: "ListMcpServerStatusResponse"},
