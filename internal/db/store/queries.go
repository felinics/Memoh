...
type Queries interface {
	...
	GetNextPendingFollowUpQueueItem(ctx context.Context, sessionID pgtype.UUID) (dbsqlc.SessionFollowUpQueue, error)
	ListPendingSteerQueue(ctx context.Context, sessionID pgtype.UUID) ([]dbsqlc.SessionSteerQueue, error)
	ListPendingSessionQueues(ctx context.Context, arg dbsqlc.ListPendingSessionQueuesParams) ([]dbsqlc.ListPendingSessionQueuesRow, error)
	LockSessionRunForAgentStepCommit(ctx context.Context, arg dbsqlc.LockSessionRunForAgentStepCommitParams) (pgtype.UUID, error)
	ReorderAcceptedFollowUpQueue(ctx context.Context, arg dbsqlc.ReorderAcceptedFollowUpQueueParams) ([]dbsqlc.ReorderAcceptedFollowUpQueueRow, error)
	ReorderAcceptedSteerQueue(ctx context.Context, arg dbsqlc.ReorderAcceptedSteerQueueParams) ([]dbsqlc.ReorderAcceptedSteerQueueRow, error)
