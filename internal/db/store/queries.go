...
type Queries interface {
	...
	ListActiveMessagesBetweenBySession(ctx context.Context, arg dbsqlc.ListActiveMessagesBetweenBySessionParams) ([]dbsqlc.ListActiveMessagesBetweenBySessionRow, error)
