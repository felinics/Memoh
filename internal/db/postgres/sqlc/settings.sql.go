...
WITH updated AS (
  ...
  SET language = $1,
      ...
      END,
      video_model_id = CASE
        WHEN $32::boolean THEN $33::uuid
        ELSE bots.video_model_id
      END,
      persist_full_tool_results = $34,
      show_tool_calls_in_im = $35,
      tool_approval_config = $36,
      display_enabled = $37,
      overlay_provider = $38,
      overlay_enabled = $39,
      overlay_config = $40,
      command_ui_language = $41,
      updated_at = now()
  WHERE bots.team_id = public.memoh_current_team_id() AND bots.id = $42
...
type UpsertBotSettingsParams struct {
	...
	CompactionModelID          pgtype.UUID `json:"compaction_model_id"`
	DiscussProbeModelIDSet     bool        `json:"discuss_probe_model_id_set"`
	DiscussProbeModelID        pgtype.UUID `json:"discuss_probe_model_id"`
