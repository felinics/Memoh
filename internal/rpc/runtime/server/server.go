...
import (
	...
	"github.com/memohai/memoh/domains/agent/extension/skills"
...
func Handlers(commandHandler *command.Handler, skillHandler *runtimehttp.ContainerdHandler, audioService *audio.Service) map[string]runtimeRpc.Handler {
