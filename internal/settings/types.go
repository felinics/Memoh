...
const (
	...
	AuxiliaryVisionInherit   = "inherit"
	AuxiliaryVisionEnabled   = "enabled"
	AuxiliaryVisionDisabled  = "disabled"
	InheritVisionMaxRetries  = -1
	MaxVisionTimeoutSeconds  = 86400
)
...
type Settings struct {
	...
	AuxiliaryVisionModelID        string             `json:"auxiliary_vision_model_id,omitempty"`
...
type UpsertRequest struct {
	...
	CompactionModelID             *string             `json:"compaction_model_id,omitempty"`
	AuxiliaryVisionMode           *string             `json:"auxiliary_vision_mode,omitempty"`
	AuxiliaryVisionModelID        *string             `json:"auxiliary_vision_model_id,omitempty"`
	AuxiliaryVisionPrompt         *string             `json:"auxiliary_vision_prompt,omitempty"`
