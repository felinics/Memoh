...
const (
	...
	ContainerService_Terminal_FullMethodName         = "/bridgepb.ContainerService/Terminal"
...
type ContainerServiceClient interface {
	...
	// Terminal attaches a browser shell. The PTY outlives this stream: cancelling
	// the stream detaches, and only an explicit release frame ends the session.
	Terminal(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[TerminalClient, TerminalServer], error)
...
func (c *containerServiceClient) Terminal(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[TerminalClient, TerminalServer], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &ContainerService_ServiceDesc.Streams[1], ContainerService_Terminal_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[TerminalClient, TerminalServer]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ContainerService_TerminalClient = grpc.BidiStreamingClient[TerminalClient, TerminalServer]
...
func (c *containerServiceClient) Tunnel(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[TunnelFrame, TunnelFrame], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &ContainerService_ServiceDesc.Streams[2], ContainerService_Tunnel_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *containerServiceClient) ReverseHTTP(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[ReverseHTTPFrame, ReverseHTTPFrame], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &ContainerService_ServiceDesc.Streams[3], ContainerService_ReverseHTTP_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *containerServiceClient) ReadRaw(ctx context.Context, in *ReadRawRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[DataChunk], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &ContainerService_ServiceDesc.Streams[4], ContainerService_ReadRaw_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *containerServiceClient) WriteRaw(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[WriteRawChunk, WriteRawResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &ContainerService_ServiceDesc.Streams[5], ContainerService_WriteRaw_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *containerServiceClient) ReadRawNoFollow(ctx context.Context, in *ReadRawNoFollowRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[DataChunk], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &ContainerService_ServiceDesc.Streams[6], ContainerService_ReadRawNoFollow_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *containerServiceClient) WriteRawNoFollow(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[WriteRawNoFollowChunk, WriteRawResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &ContainerService_ServiceDesc.Streams[7], ContainerService_WriteRawNoFollow_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
type ContainerServiceServer interface {
	...
	// Terminal attaches a browser shell. The PTY outlives this stream: cancelling
	// the stream detaches, and only an explicit release frame ends the session.
	Terminal(grpc.BidiStreamingServer[TerminalClient, TerminalServer]) error
...
func (UnimplementedContainerServiceServer) Terminal(grpc.BidiStreamingServer[TerminalClient, TerminalServer]) error {
...
func _ContainerService_Terminal_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ContainerServiceServer).Terminal(&grpc.GenericServerStream[TerminalClient, TerminalServer]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ContainerService_TerminalServer = grpc.BidiStreamingServer[TerminalClient, TerminalServer]
...
var ContainerService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "Terminal",
			Handler:       _ContainerService_Terminal_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
		{
