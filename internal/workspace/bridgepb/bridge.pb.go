...
type TerminalClient struct {
	...
	//
	//	*TerminalClient_Open
	//	*TerminalClient_Attach
	//	*TerminalClient_Input
	//	*TerminalClient_Resize
	//	*TerminalClient_Release
	Frame         isTerminalClient_Frame `protobuf_oneof:"frame"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *TerminalClient) Reset() {
	*x = TerminalClient{}
...
func (x *TerminalClient) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TerminalClient) ProtoMessage() {}

func (x *TerminalClient) ProtoReflect() protoreflect.Message {
	mi := &file_internal_workspace_bridgepb_bridge_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TerminalClient.ProtoReflect.Descriptor instead.
func (*TerminalClient) Descriptor() ([]byte, []int) {
	return file_internal_workspace_bridgepb_bridge_proto_rawDescGZIP(), []int{10}
}

func (x *TerminalClient) GetFrame() isTerminalClient_Frame {
	if x != nil {
		return x.Frame
	}
	return nil
...
func (x *TerminalClient) GetOpen() *TerminalOpen {
	if x != nil {
		if x, ok := x.Frame.(*TerminalClient_Open); ok {
			return x.Open
		}
	}
	return nil
...
func (x *TerminalClient) GetAttach() *TerminalAttach {
	if x != nil {
		if x, ok := x.Frame.(*TerminalClient_Attach); ok {
			return x.Attach
		}
	}
	return nil
...
func (x *TerminalClient) GetInput() []byte {
	if x != nil {
		if x, ok := x.Frame.(*TerminalClient_Input); ok {
			return x.Input
		}
	}
	return nil
...
func (x *TerminalClient) GetResize() *TerminalResize {
	if x != nil {
		if x, ok := x.Frame.(*TerminalClient_Resize); ok {
			return x.Resize
		}
	}
	return nil
...
func (x *TerminalClient) GetRelease() bool {
	if x != nil {
		if x, ok := x.Frame.(*TerminalClient_Release); ok {
			return x.Release
		}
	}
	return false
...
type isTerminalClient_Frame interface {
	isTerminalClient_Frame()
}

type TerminalClient_Open struct {
	Open *TerminalOpen `protobuf:"bytes,1,opt,name=open,proto3,oneof"`
}

type TerminalClient_Attach struct {
	Attach *TerminalAttach `protobuf:"bytes,2,opt,name=attach,proto3,oneof"`
}

type TerminalClient_Input struct {
	Input []byte `protobuf:"bytes,3,opt,name=input,proto3,oneof"`
}

type TerminalClient_Resize struct {
	Resize *TerminalResize `protobuf:"bytes,4,opt,name=resize,proto3,oneof"`
}

type TerminalClient_Release struct {
	Release bool `protobuf:"varint,5,opt,name=release,proto3,oneof"`
}

func (*TerminalClient_Open) isTerminalClient_Frame() {}

func (*TerminalClient_Attach) isTerminalClient_Frame() {}

func (*TerminalClient_Input) isTerminalClient_Frame() {}

func (*TerminalClient_Resize) isTerminalClient_Frame() {}

func (*TerminalClient_Release) isTerminalClient_Frame() {}
...
func (x *TerminalOpen) GetCommand() string {
	if x != nil {
		return x.Command
	}
	return ""
...
func (x *TerminalOpen) GetWorkDir() string {
	if x != nil {
		return x.WorkDir
	}
	return ""
...
func (x *TerminalAttach) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *TerminalAttach) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
...
func (x *TerminalAttach) GetSinceOffset() uint64 {
	if x != nil {
...
func (x *TerminalAttach) GetCols() uint32 {
	if x != nil {
		return x.Cols
	}
	return 0
...
func (x *TerminalAttach) GetRows() uint32 {
	if x != nil {
		return x.Rows
	}
	return 0
...
type TerminalServer struct {
	...
	// Types that are valid to be assigned to Frame:
	//
	//	*TerminalServer_Ready
	//	*TerminalServer_Bytes
	//	*TerminalServer_Exit
	Frame         isTerminalServer_Frame `protobuf_oneof:"frame"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *TerminalServer) Reset() {
	*x = TerminalServer{}
...
func (x *TerminalServer) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TerminalServer) ProtoMessage() {}

func (x *TerminalServer) ProtoReflect() protoreflect.Message {
	mi := &file_internal_workspace_bridgepb_bridge_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TerminalServer.ProtoReflect.Descriptor instead.
func (*TerminalServer) Descriptor() ([]byte, []int) {
	return file_internal_workspace_bridgepb_bridge_proto_rawDescGZIP(), []int{13}
}

func (x *TerminalServer) GetFrame() isTerminalServer_Frame {
	if x != nil {
		return x.Frame
	}
	return nil
...
func (x *TerminalServer) GetReady() *TerminalReady {
	if x != nil {
		if x, ok := x.Frame.(*TerminalServer_Ready); ok {
			return x.Ready
		}
	}
	return nil
...
func (x *TerminalServer) GetBytes() *TerminalBytes {
	if x != nil {
		if x, ok := x.Frame.(*TerminalServer_Bytes); ok {
			return x.Bytes
		}
	}
	return nil
...
func (x *TerminalServer) GetExit() *TerminalExit {
	if x != nil {
		if x, ok := x.Frame.(*TerminalServer_Exit); ok {
			return x.Exit
		}
	}
	return nil
...
type isTerminalServer_Frame interface {
	isTerminalServer_Frame()
}

type TerminalServer_Ready struct {
	Ready *TerminalReady `protobuf:"bytes,1,opt,name=ready,proto3,oneof"`
}

type TerminalServer_Bytes struct {
	Bytes *TerminalBytes `protobuf:"bytes,2,opt,name=bytes,proto3,oneof"`
}

type TerminalServer_Exit struct {
	Exit *TerminalExit `protobuf:"bytes,3,opt,name=exit,proto3,oneof"`
}

func (*TerminalServer_Ready) isTerminalServer_Frame() {}

func (*TerminalServer_Bytes) isTerminalServer_Frame() {}

func (*TerminalServer_Exit) isTerminalServer_Frame() {}

type TerminalReady struct {
	state     protoimpl.MessageState `protogen:"open.v1"`
	SessionId string                 `protobuf:"bytes,1,opt,name=session_id,json=sessionId,proto3" json:"session_id,omitempty"`
	// Absolute offset of the next TerminalBytes payload.
	Offset uint64 `protobuf:"varint,2,opt,name=offset,proto3" json:"offset,omitempty"`
	// since_offset is older than the bytes still kept in the ring.
	Truncated     bool `protobuf:"varint,3,opt,name=truncated,proto3" json:"truncated,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TerminalReady) GetOffset() uint64 {
	if x != nil {
		return x.Offset
	}
	return 0
...
func (x *TerminalReady) GetTruncated() bool {
	if x != nil {
		return x.Truncated
	}
	return false
...
type TerminalBytes struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	Data  []byte                 `protobuf:"bytes,1,opt,name=data,proto3" json:"data,omitempty"`
	// Absolute offset after data is applied.
	Offset        uint64 `protobuf:"varint,2,opt,name=offset,proto3" json:"offset,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *TerminalBytes) Reset() {
	*x = TerminalBytes{}
...
func (x *TerminalBytes) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TerminalBytes) ProtoMessage() {}

func (x *TerminalBytes) ProtoReflect() protoreflect.Message {
	mi := &file_internal_workspace_bridgepb_bridge_proto_msgTypes[15]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TerminalBytes.ProtoReflect.Descriptor instead.
func (*TerminalBytes) Descriptor() ([]byte, []int) {
	return file_internal_workspace_bridgepb_bridge_proto_rawDescGZIP(), []int{15}
}

func (x *TerminalBytes) GetData() []byte {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *TerminalBytes) GetOffset() uint64 {
	if x != nil {
		return x.Offset
	}
	return 0
...
func (x *StatResponse) Reset() {
	*x = StatResponse{}
	mi := &file_internal_workspace_bridgepb_bridge_proto_msgTypes[35]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*StatResponse) Descriptor() ([]byte, []int) {
	return file_internal_workspace_bridgepb_bridge_proto_rawDescGZIP(), []int{35}
}
...
func (x *MkdirRequest) Reset() {
	*x = MkdirRequest{}
	mi := &file_internal_workspace_bridgepb_bridge_proto_msgTypes[36]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MkdirRequest) Descriptor() ([]byte, []int) {
	return file_internal_workspace_bridgepb_bridge_proto_rawDescGZIP(), []int{36}
}
...
func (x *MkdirResponse) Reset() {
	*x = MkdirResponse{}
	mi := &file_internal_workspace_bridgepb_bridge_proto_msgTypes[37]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MkdirResponse) Descriptor() ([]byte, []int) {
	return file_internal_workspace_bridgepb_bridge_proto_rawDescGZIP(), []int{37}
}
...
func (x *RenameRequest) Reset() {
	*x = RenameRequest{}
	mi := &file_internal_workspace_bridgepb_bridge_proto_msgTypes[38]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RenameRequest) Descriptor() ([]byte, []int) {
	return file_internal_workspace_bridgepb_bridge_proto_rawDescGZIP(), []int{38}
}
...
func (x *RenameResponse) Reset() {
	*x = RenameResponse{}
	mi := &file_internal_workspace_bridgepb_bridge_proto_msgTypes[39]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RenameResponse) Descriptor() ([]byte, []int) {
	return file_internal_workspace_bridgepb_bridge_proto_rawDescGZIP(), []int{39}
}
...
const file_internal_workspace_bridgepb_bridge_proto_rawDesc = "" +
	...
	"\x04EXIT\x10\x02\"\xe3\x01\n" +
	"\x0eTerminalClient\x12,\n" +
	"\x04open\x18\x01 \x01(\v2\x16.bridgepb.TerminalOpenH\x00R\x04open\x122\n" +
	"\x06attach\x18\x02 \x01(\v2\x18.bridgepb.TerminalAttachH\x00R\x06attach\x12\x16\n" +
	"\x05input\x18\x03 \x01(\fH\x00R\x05input\x122\n" +
	"\x06resize\x18\x04 \x01(\v2\x18.bridgepb.TerminalResizeH\x00R\x06resize\x12\x1a\n" +
	"\arelease\x18\x05 \x01(\bH\x00R\areleaseB\a\n" +
	"\x05frame\"k\n" +
	"\fTerminalOpen\x12\x18\n" +
	"\acommand\x18\x01 \x01(\tR\acommand\x12\x19\n" +
	"\bwork_dir\x18\x02 \x01(\tR\aworkDir\x12\x12\n" +
	"\x04cols\x18\x03 \x01(\rR\x04cols\x12\x12\n" +
	"\x04rows\x18\x04 \x01(\rR\x04rows\"z\n" +
	"\x0eTerminalAttach\x12\x1d\n" +
	"\n" +
	"session_id\x18\x01 \x01(\tR\tsessionId\x12!\n" +
	"\fsince_offset\x18\x02 \x01(\x04R\vsinceOffset\x12\x12\n" +
	"\x04cols\x18\x03 \x01(\rR\x04cols\x12\x12\n" +
	"\x04rows\x18\x04 \x01(\rR\x04rows\"\xa9\x01\n" +
	"\x0eTerminalServer\x12/\n" +
	"\x05ready\x18\x01 \x01(\v2\x17.bridgepb.TerminalReadyH\x00R\x05ready\x12/\n" +
	"\x05bytes\x18\x02 \x01(\v2\x17.bridgepb.TerminalBytesH\x00R\x05bytes\x12,\n" +
	"\x04exit\x18\x03 \x01(\v2\x16.bridgepb.TerminalExitH\x00R\x04exitB\a\n" +
	"\x05frame\"d\n" +
	...
	"\x04Exec\x12\x13.bridgepb.ExecInput\x1a\x14.bridgepb.ExecOutput(\x010\x01\x12B\n" +
	"\bTerminal\x12\x18.bridgepb.TerminalClient\x1a\x18.bridgepb.TerminalServer(\x010\x01\x12:\n" +
...
var file_internal_workspace_bridgepb_bridge_proto_msgTypes = make([]protoimpl.MessageInfo, 40)
var file_internal_workspace_bridgepb_bridge_proto_goTypes = []any{
	...
	(*TerminalClient)(nil),         // 11: bridgepb.TerminalClient
	(*TerminalOpen)(nil),           // 12: bridgepb.TerminalOpen
	(*TerminalAttach)(nil),         // 13: bridgepb.TerminalAttach
	(*TerminalServer)(nil),         // 14: bridgepb.TerminalServer
	(*TerminalReady)(nil),          // 15: bridgepb.TerminalReady
	(*TerminalBytes)(nil),          // 16: bridgepb.TerminalBytes
	(*TerminalExit)(nil),           // 17: bridgepb.TerminalExit
	(*TunnelOpen)(nil),             // 18: bridgepb.TunnelOpen
	(*TunnelData)(nil),             // 19: bridgepb.TunnelData
	(*TunnelClose)(nil),            // 20: bridgepb.TunnelClose
	(*TunnelFrame)(nil),            // 21: bridgepb.TunnelFrame
	(*HTTPHeader)(nil),             // 22: bridgepb.HTTPHeader
	(*ReverseHTTPRequest)(nil),     // 23: bridgepb.ReverseHTTPRequest
	(*ReverseHTTPResponse)(nil),    // 24: bridgepb.ReverseHTTPResponse
	(*ReverseHTTPError)(nil),       // 25: bridgepb.ReverseHTTPError
	(*ReverseHTTPFrame)(nil),       // 26: bridgepb.ReverseHTTPFrame
	(*ReadRawRequest)(nil),         // 27: bridgepb.ReadRawRequest
	(*DataChunk)(nil),              // 28: bridgepb.DataChunk
	(*WriteRawChunk)(nil),          // 29: bridgepb.WriteRawChunk
	(*WriteRawResponse)(nil),       // 30: bridgepb.WriteRawResponse
	(*ReadRawNoFollowRequest)(nil), // 31: bridgepb.ReadRawNoFollowRequest
	(*WriteRawNoFollowChunk)(nil),  // 32: bridgepb.WriteRawNoFollowChunk
	(*DeleteFileRequest)(nil),      // 33: bridgepb.DeleteFileRequest
	(*DeleteFileResponse)(nil),     // 34: bridgepb.DeleteFileResponse
	(*StatRequest)(nil),            // 35: bridgepb.StatRequest
	(*StatResponse)(nil),           // 36: bridgepb.StatResponse
	(*MkdirRequest)(nil),           // 37: bridgepb.MkdirRequest
	(*MkdirResponse)(nil),          // 38: bridgepb.MkdirResponse
	(*RenameRequest)(nil),          // 39: bridgepb.RenameRequest
	(*RenameResponse)(nil),         // 40: bridgepb.RenameResponse
}
var file_internal_workspace_bridgepb_bridge_proto_depIdxs = []int32{
	...
	12, // 3: bridgepb.TerminalClient.open:type_name -> bridgepb.TerminalOpen
	13, // 4: bridgepb.TerminalClient.attach:type_name -> bridgepb.TerminalAttach
	9,  // 5: bridgepb.TerminalClient.resize:type_name -> bridgepb.TerminalResize
	15, // 6: bridgepb.TerminalServer.ready:type_name -> bridgepb.TerminalReady
	16, // 7: bridgepb.TerminalServer.bytes:type_name -> bridgepb.TerminalBytes
	17, // 8: bridgepb.TerminalServer.exit:type_name -> bridgepb.TerminalExit
	18, // 9: bridgepb.TunnelFrame.open:type_name -> bridgepb.TunnelOpen
	19, // 10: bridgepb.TunnelFrame.data:type_name -> bridgepb.TunnelData
	20, // 11: bridgepb.TunnelFrame.close:type_name -> bridgepb.TunnelClose
	22, // 12: bridgepb.ReverseHTTPRequest.headers:type_name -> bridgepb.HTTPHeader
	22, // 13: bridgepb.ReverseHTTPResponse.headers:type_name -> bridgepb.HTTPHeader
	23, // 14: bridgepb.ReverseHTTPFrame.request:type_name -> bridgepb.ReverseHTTPRequest
	24, // 15: bridgepb.ReverseHTTPFrame.response:type_name -> bridgepb.ReverseHTTPResponse
	25, // 16: bridgepb.ReverseHTTPFrame.error:type_name -> bridgepb.ReverseHTTPError
	6,  // 17: bridgepb.StatResponse.entry:type_name -> bridgepb.FileEntry
	1,  // 18: bridgepb.ContainerService.ReadFile:input_type -> bridgepb.ReadFileRequest
	3,  // 19: bridgepb.ContainerService.WriteFile:input_type -> bridgepb.WriteFileRequest
	5,  // 20: bridgepb.ContainerService.ListDir:input_type -> bridgepb.ListDirRequest
	35, // 21: bridgepb.ContainerService.Stat:input_type -> bridgepb.StatRequest
	37, // 22: bridgepb.ContainerService.Mkdir:input_type -> bridgepb.MkdirRequest
	39, // 23: bridgepb.ContainerService.Rename:input_type -> bridgepb.RenameRequest
	8,  // 24: bridgepb.ContainerService.Exec:input_type -> bridgepb.ExecInput
	11, // 25: bridgepb.ContainerService.Terminal:input_type -> bridgepb.TerminalClient
	21, // 26: bridgepb.ContainerService.Tunnel:input_type -> bridgepb.TunnelFrame
	26, // 27: bridgepb.ContainerService.ReverseHTTP:input_type -> bridgepb.ReverseHTTPFrame
	27, // 28: bridgepb.ContainerService.ReadRaw:input_type -> bridgepb.ReadRawRequest
	29, // 29: bridgepb.ContainerService.WriteRaw:input_type -> bridgepb.WriteRawChunk
	31, // 30: bridgepb.ContainerService.ReadRawNoFollow:input_type -> bridgepb.ReadRawNoFollowRequest
	32, // 31: bridgepb.ContainerService.WriteRawNoFollow:input_type -> bridgepb.WriteRawNoFollowChunk
	33, // 32: bridgepb.ContainerService.DeleteFile:input_type -> bridgepb.DeleteFileRequest
	2,  // 33: bridgepb.ContainerService.ReadFile:output_type -> bridgepb.ReadFileResponse
	4,  // 34: bridgepb.ContainerService.WriteFile:output_type -> bridgepb.WriteFileResponse
	7,  // 35: bridgepb.ContainerService.ListDir:output_type -> bridgepb.ListDirResponse
	36, // 36: bridgepb.ContainerService.Stat:output_type -> bridgepb.StatResponse
	38, // 37: bridgepb.ContainerService.Mkdir:output_type -> bridgepb.MkdirResponse
	40, // 38: bridgepb.ContainerService.Rename:output_type -> bridgepb.RenameResponse
	10, // 39: bridgepb.ContainerService.Exec:output_type -> bridgepb.ExecOutput
	14, // 40: bridgepb.ContainerService.Terminal:output_type -> bridgepb.TerminalServer
	21, // 41: bridgepb.ContainerService.Tunnel:output_type -> bridgepb.TunnelFrame
	26, // 42: bridgepb.ContainerService.ReverseHTTP:output_type -> bridgepb.ReverseHTTPFrame
	28, // 43: bridgepb.ContainerService.ReadRaw:output_type -> bridgepb.DataChunk
	30, // 44: bridgepb.ContainerService.WriteRaw:output_type -> bridgepb.WriteRawResponse
	28, // 45: bridgepb.ContainerService.ReadRawNoFollow:output_type -> bridgepb.DataChunk
	30, // 46: bridgepb.ContainerService.WriteRawNoFollow:output_type -> bridgepb.WriteRawResponse
	34, // 47: bridgepb.ContainerService.DeleteFile:output_type -> bridgepb.DeleteFileResponse
...
func file_internal_workspace_bridgepb_bridge_proto_init() {
	...
	file_internal_workspace_bridgepb_bridge_proto_msgTypes[10].OneofWrappers = []any{
		(*TerminalClient_Open)(nil),
		(*TerminalClient_Attach)(nil),
		(*TerminalClient_Input)(nil),
		(*TerminalClient_Resize)(nil),
		(*TerminalClient_Release)(nil),
	}
	file_internal_workspace_bridgepb_bridge_proto_msgTypes[13].OneofWrappers = []any{
		(*TerminalServer_Ready)(nil),
		(*TerminalServer_Bytes)(nil),
		(*TerminalServer_Exit)(nil),
	}
	...
	file_internal_workspace_bridgepb_bridge_proto_msgTypes[25].OneofWrappers = []any{
