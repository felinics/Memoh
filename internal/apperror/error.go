...
const (
	...
	CodeWorkspaceDependencyRepairFailed                Code = "workspace_dependency.repair_failed"
	CodeWorkspaceDependencyRepairManualRequired        Code = "workspace_dependency.repair_manual_required"
	CodeWorkspaceDependencyRepairPending               Code = "workspace_dependency.repair_pending"
	CodeWorkspaceDependencyTargetChanged               Code = "workspace_dependency.target_changed"
	CodeWorkspaceDependencyRepairAuthorizationRequired Code = "workspace_dependency.repair_authorization_required"
	CodeWorkspaceDependencyRecipeUpgradeRequired       Code = "workspace_dependency.recipe_upgrade_required"
...
var catalog = map[Code]Definition{
	...
	CodeWorkspaceDependencyRecipeUpgradeRequired: {
		HTTPStatus: http.StatusConflict,
		Detail:     "Confirm an updated dependency recipe before reinstalling this version.",
	},
	CodeWorkspaceDependencyRepairAuthorizationRequired: {
		HTTPStatus: http.StatusConflict,
		Detail:     "The dependency must be reinstalled by a bot administrator before automatic recovery can run.",
	},
	CodeWorkspaceDependencyTargetChanged: {
		HTTPStatus: http.StatusConflict,
		Detail:     "The confirmed dependency target has changed. Refresh and try again.",
	},
	CodeWorkspaceDependencyRepairPending: {
		HTTPStatus: http.StatusConflict,
		Detail:     "Recovery of the dependency is already pending.",
	},
	CodeWorkspaceDependencyRepairManualRequired: {
		HTTPStatus: http.StatusConflict,
		Detail:     "A bot administrator must resolve the dependency recovery failure.",
	},
	CodeWorkspaceDependencyRepairFailed: {
		HTTPStatus: http.StatusConflict,
		Detail:     "The authorized dependency could not be restored.",
	},
